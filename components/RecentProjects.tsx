...
const RecentProjects = () => {
  return (
    <div className="py-20" id="projects">
        <h1 className='heading text-blue-500'> 
            Projects developed by me and my team
        </h1>
  ...
  <div key={id} className='flex items-center justify-center w-[80vw] sm:w-[570px] h-[25rem] sm:h-[32rem] lg:min-h-[32.5rem] mb-10'>
    <PinContainer title={link} href={link}>
      <a href={link} target="_blank" rel="noopener noreferrer" suppressHydrationWarning>
        <div className="relative items-center justify-center sm:w-96 w-[80vw] overflow-hidden h-[20vh] lg:h-[30vh] mb-10" suppressHydrationWarning>
